 ...
 class persistanceService
{
    ...
    open class func fetchEntities(_ entityName:NSString, withPredicate predicate:[NSPredicate],sortkey:String!,order:Bool!, limit:Int!)->NSArray{
        ...
        let entetyDescription:NSEntityDescription = NSEntityDescription.entity(forEntityName: entityName as String, in: self.persistentContainer.viewContext)!
        ...
        let items:NSArray = try! self.persistentContainer.viewContext .fetch(fetchRequest) as NSArray
        return items
    }
